...
- `results/tables/thesis_evidence_summary.csv` (derived directly from processed CSVs; compact metrics to support the core Bell Labs thesis)
...
- `python scripts/research_report.py`
  - Proves artifacts can be summarized into a paper-ready narrative + machine-readable report, and regenerates `results/tables/thesis_evidence_summary.csv` to support the Bell Labs thesis with CSV-derived metrics.
...
| 17 | Bell Labs innovation map: researchers, domains, and cross-domain bridges |
